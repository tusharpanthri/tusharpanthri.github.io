...
export default function ContactPage() {
  return (
    <section className="pt-32 pb-24 border-b-4 border-near-black dark:border-[var(--dm-border)] bg-accent-yellow">
      <div className="max-w-4xl mx-auto px-6 md:px-10 text-center">
        <h1 className="text-5xl md:text-8xl font-black uppercase mb-8 tracking-tighter">Get In Touch</h1>
